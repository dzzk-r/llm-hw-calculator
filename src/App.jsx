    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          >
            ...
            <div className="mt-4 space-y-3">
              ...
              {bandwidthPreset === "manual" ? (
                  <Input label="Bandwidth (GB/s)" value={bandwidthGBsManual} onChange={setBandwidthGBsManual} min={1}
                         step={1}/>
              ) : (
              ...
              <div className="grid grid-cols-2 gap-3">
                <Slider label="Attn read factor" value={attnReadFactor} onChange={setAttnReadFactor} min={0.2} max={2.0}
                        step={0.1}/>
                <Slider label="Weights read factor" value={weightsReadFactor} onChange={setWeightsReadFactor} min={0.2}
                        max={2.0} step={0.1}/>
              </div>
            </div>
          </Card>
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-4">
          ...
          <Card title="“Impossible” explanations (how people claim 128k on 8–16GB)">
            <div className="text-xs text-zinc-500 mb-3">
              Common escape hatches. If someone claims “30B + 128k + 8GB DDR4 + 20+ tok/s”, one of these is used — or
              it’s nonsense.
            </div>
        ...
        <div className="mt-6 text-xs text-zinc-500">
          Disclaimer: model shapes are approximate; bandwidth model is intentionally pessimistic to flag impossible
          claims.
        </div>
